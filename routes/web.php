...
Route::post('/user-create', 'UserController@create')->name('userCreate'); // create user route
Route::post('/user-update/{id}', 'UserController@update')->name('userUpdate'); // update user route
Route::get('/user-delete/{id}', 'UserController@destroy')->name('userDelete'); // delete user route
...
Route::post('/comment-create/{id}', 'PostController@createComment')->name('commentCreate'); // create post route
